...
export class addBundlesColumns1601328514632 implements MigrationInterface {
    name = 'addBundlesColumns1601328514632'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `bundles` ADD `offer` int NOT NULL");
        await queryRunner.query("ALTER TABLE `bundles` ADD `passes` int NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `schedules` ADD CONSTRAINT `FK_6d282c3c17477bc4372d112fb55` FOREIGN KEY (`instructors_id`) REFERENCES `instructors`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `bundles` DROP COLUMN `passes`");
        await queryRunner.query("ALTER TABLE `bundles` DROP COLUMN `offer`");
    }
