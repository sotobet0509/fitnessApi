...
export class init1684893904307 implements MigrationInterface {
    name = 'init1684893904307'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `datosProgreso` (`id` int NOT NULL AUTO_INCREMENT COMMENT 'Identificador numérico de los datos del paciente', `pliegues_Tricipital` int NOT NULL COMMENT 'pliegues_Tricipital', `pliegues_Subescapular` int NOT NULL COMMENT 'pliegues_Subescapular', `pliegues_Bicipital` int NOT NULL COMMENT 'pliegues_Bicipital', `pliegues_Cresta_ilíaca` int NOT NULL COMMENT 'pliegues_Cresta ilíaca ', `pliegues_Supraespinal` int NOT NULL COMMENT 'pliegues_Supraespinal', `pliegues_Abdominal` int NOT NULL COMMENT 'pliegues_Abdominal', `pliegues_Muslo` int NOT NULL COMMENT 'pliegues_Muslo', `pliegues_Pantorrilla` int NOT NULL COMMENT 'pliegues_Pantorrilla', `perimetros_cintura` varchar(255) NOT NULL COMMENT 'Cintura', `perimetros_abdomen` varchar(255) NOT NULL COMMENT 'Abdomen', `perimetros_cadera` varchar(255) NOT NULL COMMENT 'Cadera', `perimetros_brazo_contraido` varchar(255) NOT NULL COMMENT 'Cintura', `perimetros_muslo` varchar(255) NOT NULL COMMENT 'Abdomen', `perimetros_pantorrilla` varchar(255) NOT NULL COMMENT 'Cadera', `resultados_peso` varchar(255) NOT NULL COMMENT 'Peso', `resultados_grasa_corporal` varchar(255) NOT NULL COMMENT 'Grasa corporal', `resultados_kg_grasa` varchar(255) NOT NULL COMMENT 'Kg Grasa', `resultados_kg_musculo` varchar(255) NOT NULL COMMENT 'Kg musculo', `resultados_suma_pliegues` int NOT NULL COMMENT 'Suma pliegues', `fecha_registro` datetime NOT NULL COMMENT 'Fecha registro', `id_usuario` varchar(36) NULL COMMENT 'Identificador del tipo UUID del usuario', PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `ejercicios` (`id` int NOT NULL AUTO_INCREMENT COMMENT 'Identificador numérico de los ejercicios del paciente', `fecha_ejercicio` datetime NOT NULL COMMENT 'Fecha ejercicio', `completado` tinyint NOT NULL COMMENT 'Bandera para indicar si el ejercicio ya se completó' DEFAULT 0, `Peso` varchar(255) NOT NULL COMMENT 'Peso', `Notas` text NULL COMMENT 'notas', `id_usuario` varchar(36) NULL COMMENT 'Identificador del tipo UUID del usuario', `categoriaEjercicioId` int NULL COMMENT 'Identificador numérico del ejercicio', `nombreEjercicioId` int NULL COMMENT 'Identificador numérico del ejercicio', `seriesId` int NULL COMMENT 'Identificador numérico de la serie', `repeticionesId` int NULL COMMENT 'Identificador numérico de la repeticiones', `descansosId` int NULL COMMENT 'Identificador numérico del descanso', PRIMARY KEY (`id`)) ENGINE=InnoDB");
