...
export class addColumnsToPurchase21603315335520 implements MigrationInterface {
    name = 'addColumnsToPurchase21603315335520'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `purchases` ADD `isCanceled` tinyint NOT NULL DEFAULT 0");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `seats` ADD CONSTRAINT `FK_fb50bf5e21a79337fa688489cf9` FOREIGN KEY (`rooms_id`) REFERENCES `rooms`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `purchases` DROP COLUMN `isCanceled`");
    }
