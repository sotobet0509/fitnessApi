...
export class init1680805053531 implements MigrationInterface {
    name = 'init1680805053531'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `datosProgreso` (`id` int NOT NULL AUTO_INCREMENT COMMENT 'Identificador numérico de los datos del paciente', `peso` varchar(255) NOT NULL COMMENT 'Peso', `imc` varchar(255) NOT NULL COMMENT 'IMC', `grasa_corporal` varchar(255) NOT NULL COMMENT 'Grasa corporal', `cintura` varchar(255) NOT NULL COMMENT 'Cintura', `abdomen` varchar(255) NOT NULL COMMENT 'Abdomen', `cadera` varchar(255) NOT NULL COMMENT 'Cadera', `fecha_registro` datetime NOT NULL COMMENT 'Fecha registro', `id_usuario` varchar(36) NULL COMMENT 'Identificador del tipo UUID del usuario', PRIMARY KEY (`id`)) ENGINE=InnoDB");
