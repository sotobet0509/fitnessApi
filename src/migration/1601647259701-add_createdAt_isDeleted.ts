...
export class addCreatedAtIsDeleted1601647259701 implements MigrationInterface {
    name = 'addCreatedAtIsDeleted1601647259701'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `instructors` ADD `isDeleted` tinyint NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `instructors` DROP COLUMN `isDeleted`");
    }
