...
export class cambiarTipo1601309788314 implements MigrationInterface {
    name = 'cambiarTipo1601309788314'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `bundles` DROP COLUMN `name`");
        await queryRunner.query("ALTER TABLE `bundles` ADD `name` varchar(255) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `bundles` DROP COLUMN `name`");
        await queryRunner.query("ALTER TABLE `bundles` ADD `name` int NOT NULL");
