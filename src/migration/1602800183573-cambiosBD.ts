...
export class cambiosBD1602800183573 implements MigrationInterface {
    name = 'cambiosBD1602800183573'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `purchases` ADD `addedClasses` int NOT NULL DEFAULT 0");
        await queryRunner.query("ALTER TABLE `purchases` ADD `addedPasses` int NOT NULL DEFAULT 0");
        await queryRunner.query("ALTER TABLE `bookings` ADD `fromPurchase` int NULL");
        ...
        await queryRunner.query("ALTER TABLE `transactions` CHANGE `comments` `comments` text NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `transactions` CHANGE `comments` `comments` text NULL DEFAULT 'NULL'");
        ...
        await queryRunner.query("ALTER TABLE `seats` ADD CONSTRAINT `FK_fb50bf5e21a79337fa688489cf9` FOREIGN KEY (`rooms_id`) REFERENCES `rooms`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `bookings` DROP COLUMN `fromPurchase`");
        await queryRunner.query("ALTER TABLE `purchases` DROP COLUMN `addedPasses`");
        await queryRunner.query("ALTER TABLE `purchases` DROP COLUMN `addedClasses`");
    }
